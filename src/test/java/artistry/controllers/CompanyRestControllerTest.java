...
@SpringBootTest
@ActiveProfiles("test")
@ContextConfiguration(classes = CompanyRestController.class)
public class CompanyRestControllerTest {

	@Autowired
	private CompanyRestController underTest;
	...
	public void testDelete_MVC_delete() throws Exception {
		// given
		// when
		mockMvc.perform(delete("/company/delete/{id}")
	...
	public void testDeleteAll_MVC_delete() throws Exception {
		// given
		// when
		mockMvc.perform(delete("/company/deleteall")
				.accept("application/json;charset=UTF-8"))
				.andExpect(status().isOk())
				;
		// then
	...
	public void testGetAll_MVC_get() throws Exception {
		// given
		// when
		MvcResult actual = mockMvc.perform(get("/company/getall")
				.accept("application/json;charset=UTF-8"))
				.andExpect(status().isOk())
				.andReturn();
		// then
	...
	public void testGetAllById_MVC_get() throws Exception {
		// given
		// when
		MvcResult actual = mockMvc.perform(get("/company/getbyid/{id}")
				.accept("application/json;charset=UTF-8"))
				.andExpect(status().isOk())
				.andReturn();
		// then
	...
	public void testCreate_MVC_post() throws Exception {
		...
		// when
		MvcResult actual = mockMvc.perform(post("/company/new")
	...
	public void testUpdate_MVC_post() throws Exception {
		...
		Company company = new Company();
		// when
		MvcResult actual = mockMvc.perform(post("/company/update")
				.contentType(MediaType.APPLICATION_JSON_VALUE)
				.content(JsonUtils.objectToJSON(company, true))
				.accept("application/json;charset=UTF-8"))
				.andExpect(status().isOk())
	...
	public void testGetAll() throws Exception {
		// given
		// when
		Iterable<Company> actual = underTest.getAll();
		// then
	...
	public void testGetAllById() throws Exception {
		...
		Long id = 0L;
		// when
		Optional<Company> actual = underTest.getAllById(id);
		// then
		assertNotNull(actual);
	}
